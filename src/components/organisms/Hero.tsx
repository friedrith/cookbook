...
const Hero = () => {
  ...
  return (
    <div className="fixed z-10 w-full h-screen text-center flex items-center justify-center p-4">
      <img
      ...
      {/* <div className="relative w-full h-full text-center flex items-center justify-center backdrop-blur-lg"> */}
      <div className="relative z-10">
        <h1 className=" mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl">
          ...
          <span className="relative whitespace-nowrap text-blue-600">
            ...
            <span className="relative">{t('_made simple')}</span>
          </span>{' '}
          {t('_for everybody')}
        </h1>
        <p className="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-slate-900">
          {t('_Cooking your best recipes will be never easier')}
        </p>
        <div className="mt-10 flex justify-center gap-x-6">
          ...
          >
            {user ? t('_Open CookBook') : t('_Try CookBook')}
          </Button.Primary>
        </div>
      </div>
      {/* </div> */}
